...
function DataRow({ label, value, highlight, suffix }: DataRowProps) {
  return (
    <div className="flex justify-between py-3 border-b border-gray-200 last:border-0">
      <span className="text-gray-500">{label}</span>
      <span className={highlight ? "text-blue-500 font-medium" : ""}>
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-1">
          ...
          <DataRow label="Market Cap Rank" value="#1" highlight />
        </div>
        <div className="space-y-1">
